...
===
- Click on [this](https://app.terraform.io/app/organizations/new?trial=workshop2023) link to create a Terraform Cloud Organization for this workshop. **Note** you must use this link to create the organization.
