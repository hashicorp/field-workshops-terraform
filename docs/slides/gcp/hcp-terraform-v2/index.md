...
???
# HCP Terraform on GCP workshop
## Getting started
This is a half-day workshop that introduces HCP Terraform using an GCP-based application for the Instruqt labs. If you're brand new to Terraform you should try the Introduction to Terraform Community Edition on GCP Instruqt track before this one.
...
1. Launch a deployment to GCP using HCP Terraform using VCS workflows
